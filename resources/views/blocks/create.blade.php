...
<div class="row">
  <div class="col-8 ml-4">
    <div class="card-header">
      <h3 class="card-title">Create new block.</h3>
...
<form action="/blocks" method="POST" class="pb-5" enctype="multipart/form-data">

    <div class="form-group">
      <label for="exampleInputName1"> <strong>Select Hostel Name</strong> </label>
