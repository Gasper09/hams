    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Student Registration Form<small class="text-danger">* is mandatory.</small></h5>
            ...
            <div class="ibox-content">
                <form method="post" action="{{ route('offreg.store') }}" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
