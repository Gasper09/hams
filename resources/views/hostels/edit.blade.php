...
<div class="row">
  <div class="col-8 ml-4">
    <div class="card-header">
        <h3 class="card-title">Edit detals for {{ $hostel->name }}.</h3>
...
<form action="/hostels/{{ $hostel->id }}" method="POST" class="pb-5" enctype="multipart/form-data">
    @method('patch')
    ...
    <div class="form-group">
      ...
      value="{{ old('blocks_capacity') ?? $hostel->blocks_capacity }}">
